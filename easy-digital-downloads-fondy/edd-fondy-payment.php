...
if (!class_exists('EDD_Fondy')) :
    ...
    class EDD_Fondy
    {
        ...
        private function __construct($file)
        {
            ...
            $this->fondy_url = 'https://pay.flitt.com/api/checkout/url/';
        ...
        public function add_settings_gateways($settings)
        {
            ...
            $edd_fondy_settings = array(
                ...
                array(
                    ...
                    'desc' => __('Enter your Merchant ID, you can find it <a href=https://portal.flitt.com/mportal/#/settings/ target=_blank>here</a>.', 'edd_fondy'),
                    'type' => 'text',
                    'size' => 'regular'
                ),
                array(
                    ...
                    'desc' => __('Enter your Secret Key, you can find it <a href=https://portal.flitt.com/mportal/#/settings/ target=_blank>here</a>.', 'edd_fondy'),
                    'type' => 'password',
                    'size' => 'regular'
                ),
                array(
        ...
        public function process_fondy_notify()
        {
            ...
            if (isset($_POST['order_id']) && $valid) {
                ...
                if (($ref != 'secure-redirect.cloudipsp.com') and ($ref != 'pay.flitt.com')) {
                    return false;
                }
                */
