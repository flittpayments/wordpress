...
class GFFondy extends GFPaymentAddOn
{
    ...
    protected $_url = 'https://flitt.com';
    protected $_title = 'Gravity Forms Flitt Add-On';
    protected $_short_title = 'Fondy';
    protected $_supports_callbacks = true;
    private $production_url = 'https://pay.flitt.com/api/checkout/url/';
    private $sandbox_url = 'https://pay.flitt.com/api/checkout/url/';
    ...
    public function plugin_settings_fields()
    {
        $description = '
            ...
            '</p>
			<ul>
			<li>' . sprintf(esc_html__('Create you free %sFondy account.%s', 'gravityformsfondy'), '<a href="https://portal.flitt.com/mportal/#/account/registration" target="_blank">', '</a>') . '</li>' .
    ...
    public function feed_list_no_item_message()
    {
        ...
        if (!rgar($settings, 'gf_fondy_configured')) {
            return sprintf(esc_html__('To get started, please configure your %sFlitt Settings%s!', 'gravityformsfondy'), '<a href="' . admin_url('admin.php?page=gf_settings&subview=' . $this->_slug) . '">', '</a>');
        } else {
    ...
    public function callback()
    {
        ...
        if (is_wp_error($is_verified)) {
            $this->log_error(__METHOD__ . '(): Fondy verification failed with an error. Aborting with a 500 error so that Flitt is resent.');
            return new WP_Error('FondyVerificationError', 'There was an error when verifying the Flitt message with', array('status_header' => 500));
        } elseif (!$is_verified) {
    ...
    public function temporary_plugin_page()
    {
        ...
        <div class="wrap about-wrap">
            ...
            <div
                class="about-text"><?php esc_html_e('Thank you! Flitt simple integration.', 'gravityformsfondy') ?></div>
            <div class="changelog">
                <hr/>
                <div class="feature-section col two-col">
                    <div class="col-1">
                        <p><?php esc_html_e('Flitt Feeds are now accessed via the Flitt sub-menu within the Form Settings for the Form you would like to integrate Flitt with.', 'gravityformsfondy') ?></p>
                    </div>
                    <div class="col-2 last-feature">
                        <img src="https://flitt.com/wp-content/themes/Fondy_EU/img/fondy-logo.svg">
                    </div>
                </div>
    ...
    {
        //no need to do anything for Flitt when it runs this function, ignore
        return false;
    }
