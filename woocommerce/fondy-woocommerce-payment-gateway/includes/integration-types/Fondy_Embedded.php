...
trait Fondy_Embedded
{
    ...
    public function includeEmbeddedAssets()
    {
        ...
        wp_enqueue_style('fondy-vue-css', 'https://pay.flitt.com/latest/checkout-vue/checkout.css', null, WC_FONDY_VERSION);
        wp_enqueue_script('fondy-vue-js', 'https://pay.flitt.com/latest/checkout-vue/checkout.js', null, WC_FONDY_VERSION);
