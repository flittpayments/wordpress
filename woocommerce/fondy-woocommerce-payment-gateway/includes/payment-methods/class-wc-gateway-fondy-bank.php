...
class WC_Gateway_Fondy_Bank extends WC_Fondy_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_description = sprintf( //translators: link
            __('All other general Flitt settings can be adjusted <a href="%s">here</a>.', 'fondy-woocommerce-payment-gateway'),
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            'enabled' => [
                ...
                'type' => 'checkbox',
                'label' => __('Enable Flitt Bank Gateway', 'fondy-woocommerce-payment-gateway'),
                'default' => 'no',
            ...
            'title' => [
                ...
                'default' => __('Flitt Online Banking', 'fondy-woocommerce-payment-gateway'),
                'desc_tip' => true,
            ],
            'description' => [
                'title' => 'Description',
