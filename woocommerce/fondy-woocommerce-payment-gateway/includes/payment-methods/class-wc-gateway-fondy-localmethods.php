    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'title' => [
                ...
                'default' => __('Flitt Local Methods', 'fondy-woocommerce-payment-gateway'),
                'desc_tip' => true,
            ],
            'description' => [
                'title' => 'Description',
                ...
                'default' => __('Pay with your local bank with Flitt online payments.', 'fondy-woocommerce-payment-gateway'),
            ],
            'integration_type' => [
