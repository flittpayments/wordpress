...
const flitt_label = flitt_settings.title || window.wp.i18n.__( 'Pay with Visa/Mastercard via Flitt', 'flitt-woocommerce-payment-gateway');
const FlittContent = () => {
    return window.wp.htmlEntities.decodeEntities(
        flitt_settings.description || window.wp.i18n.__('Pay securely by Credit or Debit Card or Internet Banking through flitt.com service.', 'flitt-woocommerce-payment-gateway')
    );
};
